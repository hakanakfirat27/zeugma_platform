...
const ClientReportVisualizationPage = () => {
  ...
  const { data: reportData } = useClientReportData(reportId, { page: 1, page_size: 1000 });
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-6 py-3 bg-green-600 text-white rounded-xl hover:bg-green-700 disabled:opacity-50 flex items-center gap-2 shadow-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg">
            <Database className="w-8 h-8 opacity-80 mb-2" />
