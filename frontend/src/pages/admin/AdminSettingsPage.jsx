...
import { 
  Settings, Palette, Bell, Shield, Database, Mail, Globe,
  Users, CreditCard, FileText, ChevronRight, Search,
  Sun, Moon, Monitor, ToggleLeft, Eye, EyeOff, Check,
  RefreshCw, AlertCircle, Sidebar, Layout, ChevronDown,
  Lock, Key, Building2, Webhook, Server, HardDrive,
  Zap, Clock, Languages, Megaphone, MessageSquare,
  Volume2, VolumeX, Send, Clock3, UserCog, CheckCircle,
  XCircle, Info, Smartphone, Laptop, Trash2, TestTube,
  BellRing, BellOff, History, Activity, AlertTriangle,
  ShieldCheck, ShieldOff, KeyRound, UserX, Plus, Copy,
  Hash, Timer, Ban, CircleDot, Filter, Download,
  LogIn, LogOut, MoreVertical, Edit2, Power, Network,
  FileWarning, ClipboardList
} from 'lucide-react';
...
const settingsSections = [
  { 
    ...
    icon: Palette, 
    description: 'Dark mode, sidebar styles, toggle variants',
    color: 'text-purple-500',
    bgColor: 'bg-purple-50 dark:bg-purple-900/20',
    keywords: ['dark mode', 'light mode', 'theme', 'appearance', 'sidebar', 'toggle', 'style', 'layout', 'color', 'night', 'day']
  },
  { 
    id: 'notifications', 
    name: 'Notifications', 
...
const AdminSettingsPage = () => {
  ...
  // Get active section from URL or default to 'theme'
  const activeSection = searchParams.get('section') || 'theme';
      ...
      <div className="flex h-[calc(100vh-73px)]">
        ...
        <div className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900">
          <div className="p-6 max-w-5xl">
            ...
            {activeSection !== 'theme' && activeSection !== 'notifications' && activeSection !== 'security' && activeSection !== 'email' && activeSection !== 'integrations' && activeSection !== 'system' && (
