        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-md w-full mx-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Save Current Search</h3>
              <button
                onClick={() => {
                  setShowSaveModal(false);
                  setFormData({ name: '', description: '', is_default: false });
            ...
            <form onSubmit={handleSaveCurrentSearch}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
      ...
      {showManageModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">My Saved Searches</h3>
              <button
            ...
            {savedSearches.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">No saved searches yet</p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-semibold text-gray-900 dark:text-white">{search.name}</h4>
                          {search.is_default && (
                        ...
                        {search.description && (
                          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{search.description}</p>
                        )}
