// frontend/src/components/widgets/DatabaseStatusWidget.jsx
  ...
  useEffect(() => {
    const fetchStatus = async () => {
      try {
        ...
        setStatus({
          healthy: dbStatus.status === 'healthy',
          message: dbStatus.status === 'healthy' ? 'Connected and responding' : 'Connection issues detected'
        });
      } catch (error) {
