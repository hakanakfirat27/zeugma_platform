 ...
 * Includes country code (ISO 3166-1 alpha-2) and flag emoji
 * Flag emojis are generated programmatically from country codes
 */

/**
 * Convert country code to flag emoji
 * Flag emojis are created using regional indicator symbols
 * Each letter is converted to its corresponding regional indicator
 */
 ...
 * Flags are generated automatically from codes
 */
const COUNTRY_DATA = [
...
/**
 * Generate countries array with flags
 */
export const COUNTRIES = COUNTRY_DATA.map(country => ({
  code: country.code,
  name: country.name,
